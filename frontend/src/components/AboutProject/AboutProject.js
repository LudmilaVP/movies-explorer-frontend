  ...
  return (
    <section className="about-project" id="about-project">
      ...
      <div className="about-project__timeline">
        <p className="about-project__timeline-diagram about-project__timeline-diagram_backend">1 неделя</p>
        <p className="about-project__timeline-diagram about-project__timeline-diagram_frontend">4 недели</p>
